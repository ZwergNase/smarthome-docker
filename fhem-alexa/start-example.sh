...
sudo docker run --detach  --restart=always --name fhem-alexa --mount source=fhem_data,target=/home/fhem --mount source=weewx_share,target=/var/www/weewx --device /dev/ttyUSB0:/dev/ttyUSB0 --publish 8083-8085:8083-8085 oliverf/fhem-alexa:latest
...
# --name=fhem-alexa                             	Container "fhem-alexa" nennen / name container "fhem-alexa"
